<div class="bids index">
	...
	<tr>
		...
		<td><?php echo h($bid['Bid']['vehicle']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($bid['Vehicle']['id'], array('controller' => 'vehicles', 'action' => 'view', $bid['Vehicle']['id'])); ?>
		</td>
		<td><?php echo h($bid['Bid']['amount']); ?>&nbsp;</td>
		<td><?php echo h($bid['Bid']['user']); ?>&nbsp;</td>
		<td><?php echo h($bid['Bid']['time']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $bid['Bid']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $bid['Bid']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bid['Bid']['id']), array(), __('Are you sure you want to delete # %s?', $bid['Bid']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
